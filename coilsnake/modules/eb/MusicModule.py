...
class MusicModule(EbModule):
    ...
    FREE_RANGES = [ # Every single vanilla pack location
        (0x29E084,0x29FFFF), #AUDIO_PACK_66  $CBE02A
        (0x2DBCE9,0x2DFFFF), #AUDIO_PACK_71  $CCF617
        (0x28F872,0x28FFFF), #AUDIO_PACK_102 $CEF8C6
        (0x2D0D67,0x2DFFFF), #AUDIO_PACK_94  $CFF2B5
        (0x2C8864,0x2CFFFF), #AUDIO_PACK_139 $D0DFB4
        (0x2DD04B,0x2DFFFF), #AUDIO_PACK_61  $D8F6B7
        (0x2EFC32,0x2EFFFF), #AUDIO_PACK_45  $D9FC18
        (0x2EE5D4,0x2EFFFF), #AUDIO_PACK_111 $DAFB07
        (0x2D19EA,0x2DFFFF), #AUDIO_PACK_65  $DBF2EB
        (0x2CA858,0x2CFFFF), #AUDIO_PACK_156 $DCE037
        (0x2F5CF4,0x2FFFFF), #AUDIO_PACK_75  $DDFECE
        (0x2F2FF2,0x2FFFFF), #AUDIO_PACK_143 $DEFCDD
        (0x2CD924,0x2CFFFF), #AUDIO_PACK_4   $DFEC46
        (0x22ED2C,0x22FFFF), #AUDIO_PACK_110 $E0ED03
        (0x2D6BEE,0x2DFFFF), #AUDIO_PACK_123 $E1F581 
        (0x220000,0x22FFFF), #AUDIO_PACK_108 $E20000
        (0x230000,0x23FFFF), #AUDIO_PACK_3   $E30000
        (0x240000,0x24FFFF), #AUDIO_PACK_64  $E40000
        (0x250000,0x25FFFF), #AUDIO_PACK_50  $E50000
        (0x260000,0x26FFFF), #AUDIO_PACK_1   $E60000
        (0x270000,0x27FFFF), #AUDIO_PACK_78  $E70000
        (0x280000,0x28FFFF), #AUDIO_PACK_84  $E80000
        (0x290000,0x29FFFF), #AUDIO_PACK_27  $E90000
        (0x2A0000,0x2AFFFF), #AUDIO_PACK_54  $EA0000
        (0x2B0000,0x2BFFFF), #AUDIO_PACK_44  $EB0000
        (0x2C0000,0x2CFFFF), #AUDIO_PACK_114 $EC0000
        (0x2D0000,0x2DFFFF), #AUDIO_PACK_121 $ED0000
    ]
    SONG_PACK_TABLE_ROM_ADDR = 0xC4CAA5        #C4F70A
    PACK_POINTER_TABLE_ROM_ADDR = 0xC4CCE2     #C4F947
